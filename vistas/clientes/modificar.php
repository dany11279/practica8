...
<?php include_once '../../includes/header.php'?>
    <div class="container">
        ...
        <div class="row justify-content-center">
            <form action="/practica8/controladores/clientes/modificar.php" method="POST" class="col-lg-8 border bg-light p-3">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="number" step="0.01" min="0" name="cliente_nit" id="cliente_nit" class="form-control" value="<?= $clientes[0]['CLIENTE_NIT'] ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
